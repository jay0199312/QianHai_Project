...
//介绍类
import About from './page/introduction/About.vue'
import Invitation from './page/introduction/invitation.vue'
...
import myCarChoose from './page/UserModule/my-car-choose.vue'
import carMessageChange from './page/UserModule/car-message-change.vue'
import myLogin from './page/UserModule/my-login.vue'
import myRegister from './page/UserModule/my-register.vue'
import forgotPassword from './page/UserModule/forgot-password.vue'
import changeKeyword from './page/UserModule/change-keyword.vue'
import feedBack from './page/UserModule/Feedback.vue'
...
const router = new VueRouter({
  ...
  routes:[
    ...
    { path: '/myCarChoose' ,component:myCarChoose},
    { path: '/carMessageChange' ,component:carMessageChange},
    { path: '/myLogin' ,component:myLogin},
    { path: '/myRegister' ,component:myRegister},
    { path: '/forgotPassword' ,component:forgotPassword},
    { path: '/changeKeyword' ,component:changeKeyword},
